...
socket.on('state', function(players) {
  //console.log(players);
  var colours=['silver','grey','red','black','maroon','yellow','olive','green','blue','purple','aqua','salmon','crimson','darkred','pink','hotpink','deeppink','mediumvioletred','coral','orangered','orange','tomato','gold','khaki','darkkhaki','plum','orchid','violet','magenta','blueviolet','indigo','staleblue','darkstaleblue','lawangreen','seagreen','olive','teal','aquamarine','deepskyblue','royalblue','navy','wheat','tan','peru','chocolate','brown','slategray'];
  ...
  for (var id in players) {
    ...
    context.fillStyle = colours[id.charAt(0).charCodeAt(0)%colours.length];
    context.beginPath();
